...
template <typename T>
inline void Matrix33<T>::makeR(const Vec3T& r)
{
...
template <typename T>
inline void Matrix33<T>::makeS(const Vec3T& s)
{
...
template <typename T>
inline void Matrix33<T>::makeSR(const Vec3T& s, const Vec3T& r)
{
    Matrix33CalcCommon<T>::makeSR(*this, s, r);
}

template <typename T>
inline void Matrix33<T>::makeSRIdx(const Vec3T& s, const Vector3<u32>& r)
{
    Matrix33CalcCommon<T>::makeSRIdx(*this, s, r);
}

template <typename T>
inline void Matrix33<T>::makeSRzxyIdx(const Vec3T& s, const Vector3<u32>& r)
{
...
template <typename T>
inline Matrix34<T>::Matrix34(const Mtx33& mtx33, const Vec3T& t)
{
...
template <typename T>
inline void Matrix34<T>::makeQT(const QuatT& q, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeQT(*this, q, t);
}

template <typename T>
inline void Matrix34<T>::makeR(const Vec3T& r)
{
...
template <typename T>
inline void Matrix34<T>::makeRT(const Vec3T& r, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeRT(*this, r, t);
}

template <typename T>
inline void Matrix34<T>::makeRTIdx(const Vector3<u32>& r, const Vec3T& t)
{
...
template <typename T>
inline void Matrix34<T>::makeRzxyTIdx(const Vector3<u32>& r, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeRzxyTIdx(*this, r, t);
}

template <typename T>
inline void Matrix34<T>::makeS(const Vec3T& s)
{
...
template <typename T>
inline void Matrix34<T>::makeSR(const Vec3T& s, const Vec3T& r)
{
    Matrix34CalcCommon<T>::makeSR(*this, s, r);
}

template <typename T>
inline void Matrix34<T>::makeSRIdx(const Vec3T& s, const Vector3<u32>& r)
{
    Matrix34CalcCommon<T>::makeSRIdx(*this, s, r);
}

template <typename T>
inline void Matrix34<T>::makeSRT(const Vec3T& s, const Vec3T& r, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeSRT(*this, s, r, t);
}

template <typename T>
inline void Matrix34<T>::makeSRTIdx(const Vec3T& s, const Vector3<u32>& r, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeSRTIdx(*this, s, r, t);
}

template <typename T>
inline void Matrix34<T>::makeSRzxyIdx(const Vec3T& s, const Vector3<u32>& r)
{
    Matrix34CalcCommon<T>::makeSRzxyIdx(*this, s, r);
}

template <typename T>
inline void Matrix34<T>::makeSRzxyTIdx(const Vec3T& s, const Vector3<u32>& r, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeSRzxyTIdx(*this, s, r, t);
}

template <typename T>
inline void Matrix34<T>::makeST(const Vec3T& s, const Vec3T& t)
{
    Matrix34CalcCommon<T>::makeST(*this, s, t);
}

template <typename T>
inline void Matrix34<T>::makeT(const Vec3T& t)
{
...
template <typename T>
inline void Matrix34<T>::getBase(Vec3T& o, s32 axis) const
{
    Matrix34CalcCommon<T>::getBase(o, *this, axis);
}

template <typename T>
inline void Matrix34<T>::getRow(Vec4T& o, s32 row) const
{
    Matrix34CalcCommon<T>::getRow(o, *this, row);
}

template <typename T>
inline void Matrix34<T>::getTranslation(Vec3T& o) const
{
...
template <typename T>
inline void Matrix34<T>::setBase(s32 axis, const Vec3T& v)
{
    Matrix34CalcCommon<T>::setBase(*this, axis, v);
}

template <typename T>
inline void Matrix34<T>::setRow(s32 row, const Vec4T& v)
{
    Matrix34CalcCommon<T>::setRow(*this, v, row);
}

template <typename T>
inline void Matrix34<T>::setTranslation(const Vec3T& t)
{
...
template <typename T>
inline Matrix44<T>::Matrix44(const Mtx33& mtx33, const Vec3T& t, const Vec4T& vw)
{
    Matrix44CalcCommon<T>::copy(*this, mtx33, t, vw);
}

template <typename T>
inline Matrix44<T>::Matrix44(const Mtx34& mtx34, const Vec4T& vw)
{
...
template <typename T>
inline void Matrix44<T>::makeR(const Vec3T& r)
{
...
template <typename T>
inline void Matrix44<T>::getCol(Vec4T& o, s32 axis) const
{
    Matrix44CalcCommon<T>::getCol(o, *this, axis);
}

template <typename T>
inline void Matrix44<T>::getRow(Vec4T& o, s32 row) const
{
...
template <typename T>
inline void Matrix44<T>::setCol(s32 axis, const Vec4T& v)
{
    Matrix44CalcCommon<T>::setCol(*this, axis, v);
}

template <typename T>
inline void Matrix44<T>::setRow(s32 row, const Vec4T& v)
{
